...
public interface BaseSpan<T> {
    ...
    @Nonnull
    @Deprecated
    T addTag(String key, String value);
    ...
    @Nonnull
    @Deprecated
    T addLabel(String key, String value);
    ...
    @Nonnull
    @Deprecated
    T addLabel(String key, Number value);
    ...
    @Nonnull
    @Deprecated
    T addLabel(String key, boolean value);
     ...
     */
    @Nonnull
    T setLabel(String key, String value);
     ...
     */
    @Nonnull
    T setLabel(String key, Number value);
     ...
     */
    @Nonnull
    T setLabel(String key, boolean value);
     ...
     * @since 1.5.0
     */
    T setStartTimestamp(long epochMicros);

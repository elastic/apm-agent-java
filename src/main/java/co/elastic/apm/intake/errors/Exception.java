...
public class Exception {
    ...
    public Exception withModule(String module) {
        this.module = module;
        return this;
    }
    ...
    public Exception withAttributes(Attributes attributes) {
        this.attributes = attributes;
        return this;
    }
    ...
    public Exception withStacktrace(List<Stacktrace> stacktrace) {
        this.stacktrace = stacktrace;
        return this;
    }
    ...
    public Exception withHandled(boolean handled) {
        this.handled = handled;
        return this;
    }

...
class ExternalProcessSpanContext implements ApmSpanContext {
    ...
    public String toTraceId() {
        // co.elastic.apm.agent.opentracingimpl.ExternalSpanContextInstrumentation$ToTraceIdInstrumentation
        return "";
    }

    @Override
    public String toSpanId() {
        // co.elastic.apm.agent.opentracingimpl.ExternalSpanContextInstrumentation$ToSpanIdInstrumentation
        return "";
    }

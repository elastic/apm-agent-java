...
public abstract class AbstractRestTemplateInstrumentation extends ElasticApmInstrumentation {
    ...
    public AbstractRestTemplateInstrumentation(ElasticApmTracer tracer) {
        synchronized (AbstractRestTemplateInstrumentation.class) {

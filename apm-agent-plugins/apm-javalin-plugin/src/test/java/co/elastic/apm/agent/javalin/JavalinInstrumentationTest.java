...
public class JavalinInstrumentationTest extends AbstractInstrumentationTest {
    ...
    public void testAddLambdaAddHandler() throws Exception {
        ...
        assertThat(reporter.getFirstSpan().getNameAsString()).isEqualTo("GET /test");
    }
    ...
    public void testNonAnonymousHandlerClass() throws Exception {
        ...
        assertThat(reporter.getFirstTransaction().getNameAsString()).isEqualTo("GET /my-handler");
        assertThat(reporter.getFirstSpan().getNameAsString()).isEqualTo("GET /my-handler");
    }
    ...
    public void testClassMethodReturningLambda() throws Exception {
        ...
        assertThat(reporter.getFirstSpan().getNameAsString()).isEqualTo("GET " + endpoint);
    }

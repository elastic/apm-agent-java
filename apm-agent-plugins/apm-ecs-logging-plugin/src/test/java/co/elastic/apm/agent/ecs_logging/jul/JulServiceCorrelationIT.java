...
public class JulServiceCorrelationIT extends EcsServiceCorrelationIT {

    @Override
    protected String getArtifactName() {
        return "jul-ecs-formatter";
    }

    @Override
    protected String getServiceNameTestClass() {
        return "co.elastic.apm.agent.ecs_logging.jul.JulServiceNameInstrumentationTest";
    }

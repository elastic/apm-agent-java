...
public class Log4j2ServiceCorrelationIT extends EcsServiceCorrelationIT {

    @Override
    protected String getArtifactName() {
        return "log4j2-ecs-layout";
    }

    @Override
    protected String getServiceNameTestClass() {
        return "co.elastic.apm.agent.ecs_logging.log4j2.Log4j2ServiceNameInstrumentationTest";
    }

...
public class Log4j2ServiceVersionInstrumentation extends TracerAwareInstrumentation {
    ...
    public ElementMatcher<? super TypeDescription> getTypeMatcher() {
        return named("co.elastic.logging.log4j2.EcsLayout$Builder").and(declaresMethod(named("setServiceVersion")));
    }

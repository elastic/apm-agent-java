...
public class StatementRunnerInstrumentationIT extends AbstractNeo4jInstrumentationTest {
    ...
    public void testTransaction_implicit() {
        ...
        assertThat(reporter.getFirstSpan().getNameAsString()).isEqualTo("MATCH");

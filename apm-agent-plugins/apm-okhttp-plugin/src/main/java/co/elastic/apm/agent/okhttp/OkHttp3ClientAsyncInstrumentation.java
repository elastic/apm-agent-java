...
public class OkHttp3ClientAsyncInstrumentation extends ElasticApmInstrumentation {
    ...
    @Nullable
    @VisibleForAdvice
    public static HelperClassManager<WrapperCreator<Callback>> helper;


    @Override
    public void init(ElasticApmTracer tracer) {
        helper = HelperClassManager.ForAnyClassLoader.of(tracer,
    ...
    public static class OkHttpClient3ExecuteAdvice {
        ...
        private static void onBeforeEnqueue(@Advice.Origin Class<? extends Call> clazz,
            ...
            System.out.println("onBeforeEnqueue");
            if (tracer == null || tracer.getActive() == null || helper == null) {
                return;
            }
            ...
            if (span != null) {
                final WrapperCreator<Callback> wrapperCreator = helper.getForClassLoaderOfClass(clazz);
                if (wrapperCreator != null) {
                    System.out.println(wrapperCreator);

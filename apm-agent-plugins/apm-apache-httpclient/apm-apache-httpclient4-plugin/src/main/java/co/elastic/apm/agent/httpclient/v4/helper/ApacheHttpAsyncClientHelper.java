...
public class ApacheHttpAsyncClientHelper implements AbstractApacheHttpAsyncClientHelper<HttpAsyncRequestProducer, HttpAsyncRequestProducerWrapper, FutureCallback, FutureCallbackWrapper<?>, HttpContext> {

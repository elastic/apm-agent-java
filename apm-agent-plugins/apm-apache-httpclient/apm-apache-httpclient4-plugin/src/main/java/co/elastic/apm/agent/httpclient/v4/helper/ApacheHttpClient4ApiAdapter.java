...
public class ApacheHttpClient4ApiAdapter implements ApacheHttpClientApiAdapter<HttpRequestWrapper, HttpRequest, HttpHost, CloseableHttpResponse> {
    ...
    @Override
    public URI getUri(HttpRequestWrapper request) throws URISyntaxException {

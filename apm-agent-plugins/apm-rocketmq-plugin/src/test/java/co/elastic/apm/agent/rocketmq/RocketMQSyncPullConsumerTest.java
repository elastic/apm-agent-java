...
//    private static String topic = "ApmRocketMQPluginTest-4";
...
//        consumer = new DefaultMQPullConsumer("rocketmq-sync-pull-consumer");
//        consumer.setNamesrvAddr(RCOKETMQ_NAME_SRV);
//        consumer.start();
...
//                            PullResultExt pullResult = (PullResultExt) consumer.pull(mq, "*", offset, 32);

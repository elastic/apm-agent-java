...
class ElasticApmApiInstrumentationTest extends AbstractInstrumentationTest {
    ...
    void testTraceContextScopes() {
        co.elastic.apm.agent.impl.transaction.Transaction transaction = tracer.startTransaction(TraceContext.asRoot(), null, null);
    ...
    void testOverrideServiceNameForClassLoader() {
        ...
        assertThat(reporter.getFirstTransaction().getServiceName()).isEqualTo("overridden");
    }

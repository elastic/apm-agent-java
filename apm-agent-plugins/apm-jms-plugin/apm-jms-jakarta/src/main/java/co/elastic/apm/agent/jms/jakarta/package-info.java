 ...
 * {@link jakarta.jms.MessageListener#onMessage(jakarta.jms.Message)} API) or active (i.e. polling, for example through the
 * {@link jakarta.jms.MessageConsumer#receive()} API).
 * <p>

...
import co.elastic.apm.agent.jms.JakartaJmsMessagePropertyAccessor;
...
class JakartaJmsMessagePropertyAccessorTest {
    ...
    void returnsNullOnJMSException() throws JMSException {
        ...
        assertThat(JakartaJmsMessagePropertyAccessor.instance().getFirstHeader("header", msg)).isNull();
    }
    ...
    void setHeader() throws JMSException {
        ...
        JakartaJmsMessagePropertyAccessor.instance().setHeader(TraceContext.ELASTIC_TRACE_PARENT_TEXTUAL_HEADER_NAME, "header-value", msg);
    ...
    void setHeaderSkipIfPresent() throws JMSException {
        ...
        JakartaJmsMessagePropertyAccessor.instance().setHeader(header, newValue, msg);
    }
    ...
    void setHeaderException(Class<? extends JMSException> exceptionType) throws JMSException {
        ...
        JakartaJmsMessagePropertyAccessor.instance().setHeader("", "", msg);
    }

...
public class JakartaJmsInstrumentationIT extends AbstractInstrumentationTest {
    ...
    @Parameterized.Parameters(name = "JakartaBrokerFacade={1}")
    public static Iterable<Object[]> brokerFacades() {
        //only artemis tested, the older non-artemis ActiveMQ is not supported with jakarta.jms
        return Arrays.asList(new Object[][]{{new JakartaActiveMqArtemisFacade(), JakartaActiveMqArtemisFacade.class}});
    }

...
public class JmsMessageConsumerInstrumentation extends BaseJmsInstrumentation {
    public JmsMessageConsumerInstrumentation(ElasticApmTracer tracer) {
        super(tracer);
    }
                    ...
                    if (message != null) {
                        if (abstractSpan instanceof Transaction) {
                            try {
                                ...
                                LoggerFactory.getLogger("JmsMessageConsumerInstrumentation")
                                    .error("Failed to retrieve trace context from Message", e);
                            }
                        }

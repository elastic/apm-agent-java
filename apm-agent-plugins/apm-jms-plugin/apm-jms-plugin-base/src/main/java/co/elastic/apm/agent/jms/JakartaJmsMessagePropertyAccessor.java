...
import static co.elastic.apm.agent.jms.JakartaJmsInstrumentationHelper.JMS_TRACE_PARENT_PROPERTY;

public class JakartaJmsMessagePropertyAccessor extends AbstractHeaderGetter<String, Message> implements TextHeaderGetter<Message>, TextHeaderSetter<Message> {

    private static final Logger logger = LoggerFactory.getLogger(JakartaJmsMessagePropertyAccessor.class);

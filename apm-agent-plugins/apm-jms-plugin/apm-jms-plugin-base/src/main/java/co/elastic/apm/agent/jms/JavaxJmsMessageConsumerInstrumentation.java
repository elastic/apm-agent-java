...
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.MESSAGE_HANDLING;
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.MESSAGE_POLLING;
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.MESSAGING_TYPE;
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.RECEIVE_NAME_PREFIX;

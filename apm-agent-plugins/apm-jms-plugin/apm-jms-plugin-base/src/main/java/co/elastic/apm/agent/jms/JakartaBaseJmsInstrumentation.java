...
public abstract class JakartaBaseJmsInstrumentation extends BaseJmsInstrumentation {
    ...
    protected static class JakartaBaseAdvice extends BaseAdvice {

        protected static final JakartaJmsInstrumentationHelper helper;
        ...
        static {
            ...
            helper = new JakartaJmsInstrumentationHelper(elasticApmTracer);
        }
    }
}

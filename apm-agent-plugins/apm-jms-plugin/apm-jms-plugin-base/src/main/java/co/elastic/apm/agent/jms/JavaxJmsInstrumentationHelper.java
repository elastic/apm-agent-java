...
public class JavaxJmsInstrumentationHelper extends JmsInstrumentationHelper<Message, Destination, JMSException, MessageListener>{
    ...
    TextHeaderGetter<Message> propertyAccessorGetter() {
        return JavaxJmsMessagePropertyAccessor.instance();
    }

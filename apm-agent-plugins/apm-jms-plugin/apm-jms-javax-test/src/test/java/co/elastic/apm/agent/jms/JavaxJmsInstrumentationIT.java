...
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.JMS_EXPIRATION_HEADER;
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.JMS_MESSAGE_ID_HEADER;
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.JMS_TIMESTAMP_HEADER;
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.JMS_TRACE_PARENT_PROPERTY;
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.MESSAGING_TYPE;
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.TEMP;
import static co.elastic.apm.agent.jms.JavaxJmsInstrumentationHelper.TIBCO_TMP_QUEUE_PREFIX;

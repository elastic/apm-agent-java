...
public class Spring6ExceptionHandlerInstrumentation extends TracerAwareInstrumentation {

    @Override
    public String getAdviceClassName() {
        return Spring6ExceptionHandlerInstrumentation.class.getName() + "$ExceptionHandlerAdviceService";
    }

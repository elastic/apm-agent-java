...
public class Spring5TransactionNameInstrumentationTest extends AbstractSpringTransactionNameInstrumentationTest {
    ...
    @Configuration
    public static class TestConfiguration extends AbstractSpringTransactionNameInstrumentationTest.AbstractTestConfiguration {

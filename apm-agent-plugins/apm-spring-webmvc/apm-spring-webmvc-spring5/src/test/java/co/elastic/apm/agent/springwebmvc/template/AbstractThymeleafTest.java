...
@ContextConfiguration(classes = {AbstractThymeleafTest.ThymeleafController.class})
public abstract class AbstractThymeleafTest extends AbstractViewRenderingInstrumentationTest {

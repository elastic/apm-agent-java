...
public class BridgeObservableDoubleMeasurement extends AbstractBridgedElement<ProxyObservableDoubleMeasurement> implements ObservableDoubleMeasurement {

    public BridgeObservableDoubleMeasurement(ProxyObservableDoubleMeasurement delegate) {
        super(delegate);
    }

...
public class ProxyDoubleCounterBuilder {
    ...
    public ProxyDoubleCounterBuilder(DoubleCounterBuilder delegate) {
    ...
    public ProxyDoubleCounter build() {
        return new ProxyDoubleCounter(delegate.build());
    }

    public ProxyDoubleCounterBuilder setUnit(String arg0) {
    ...
    public ProxyDoubleCounterBuilder setDescription(String arg0) {
        delegate.setDescription(arg0);
        return this;
    }

    public ProxyObservableDoubleCounter buildWithCallback(Consumer<ProxyObservableDoubleMeasurement> arg0) {
        return new ProxyObservableDoubleCounter(delegate.buildWithCallback(new Consumer<ObservableDoubleMeasurement>() {
            @Override

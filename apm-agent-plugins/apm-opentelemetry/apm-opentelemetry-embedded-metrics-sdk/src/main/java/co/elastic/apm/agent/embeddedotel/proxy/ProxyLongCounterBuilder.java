...
public class ProxyLongCounterBuilder {
    ...
    public ProxyLongCounterBuilder(LongCounterBuilder delegate) {
    ...
    public ProxyLongCounter build() {
        return new ProxyLongCounter(delegate.build());
    }

    public ProxyDoubleCounterBuilder ofDoubles() {
        return new ProxyDoubleCounterBuilder(delegate.ofDoubles());
    }

    public ProxyLongCounterBuilder setUnit(String arg0) {
    ...
    public ProxyLongCounterBuilder setDescription(String arg0) {
        delegate.setDescription(arg0);
        return this;
    }

    public ProxyObservableLongCounter buildWithCallback(Consumer<ProxyObservableLongMeasurement> arg0) {
        return new ProxyObservableLongCounter(delegate.buildWithCallback(new Consumer<ObservableLongMeasurement>() {
            @Override

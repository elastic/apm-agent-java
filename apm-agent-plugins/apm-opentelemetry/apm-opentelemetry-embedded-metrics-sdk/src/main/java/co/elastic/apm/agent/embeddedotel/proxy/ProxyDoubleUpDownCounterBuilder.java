...
public class ProxyDoubleUpDownCounterBuilder {
    ...
    public ProxyDoubleUpDownCounterBuilder(DoubleUpDownCounterBuilder delegate) {
    ...
    public ProxyDoubleUpDownCounter build() {
        return new ProxyDoubleUpDownCounter(delegate.build());
    }

    public ProxyDoubleUpDownCounterBuilder setUnit(String arg0) {
    ...
    public ProxyDoubleUpDownCounterBuilder setDescription(String arg0) {
        delegate.setDescription(arg0);
        return this;
    }

    public ProxyObservableDoubleUpDownCounter buildWithCallback(Consumer<ProxyObservableDoubleMeasurement> arg0) {
        return new ProxyObservableDoubleUpDownCounter(delegate.buildWithCallback(new Consumer<ObservableDoubleMeasurement>() {
            @Override

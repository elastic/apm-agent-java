...
public class KafkaLegacyClientIT extends AbstractInstrumentationTest {
    ...
    private void verifySendSpanContents(Span sendSpan) {
        ...
        assertThat(sendSpan.getNameAsString()).isEqualTo("KafkaProducer#send to " + KafkaLegacyClientIT.REQUEST_TOPIC);
        SpanContext context = sendSpan.getContext();
        Message message = context.getMessage();
        assertThat(message.getQueueName()).isEqualTo(KafkaLegacyClientIT.REQUEST_TOPIC);
        ...
        assertThat(service.getType()).isEqualTo("messaging");
        assertThat(service.getResource().toString()).isEqualTo("kafka/" + KafkaLegacyClientIT.REQUEST_TOPIC);
        assertThat(service.getName().toString()).isEqualTo("kafka");
    }

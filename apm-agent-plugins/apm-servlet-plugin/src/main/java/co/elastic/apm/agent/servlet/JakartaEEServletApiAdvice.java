...
import co.elastic.apm.agent.servlet.helper.JakartaEEServletTransactionCreationHelper;
...
public class JakartaEEServletApiAdvice {
    ...
    private static final JakartaEEServletTransactionCreationHelper servletTransactionCreationHelper;

    static {
        servletTransactionHelper = new ServletTransactionHelper(GlobalTracer.requireTracerImpl());
        servletTransactionCreationHelper = new JakartaEEServletTransactionCreationHelper(GlobalTracer.requireTracerImpl());
    }

    private static final GlobalThreadLocal<Boolean> excluded = GlobalThreadLocal.get(JakartaEEServletApiAdvice.class, "excluded");
    private static final GlobalThreadLocal<Object> servletPathTL = GlobalThreadLocal.get(JakartaEEServletApiAdvice.class, "servletPath");
    private static final GlobalThreadLocal<Object> pathInfoTL = GlobalThreadLocal.get(JakartaEEServletApiAdvice.class, "pathInfo");

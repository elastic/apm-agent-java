...
public class JakartaEERecordingServletInputStreamWrapper extends ServletInputStream {

    private final Request request;
    private final ServletInputStream servletInputStream;

    public JakartaEERecordingServletInputStreamWrapper(Request request, ServletInputStream servletInputStream) {

 ...
 */
public class JakartaEEApmAsyncListener implements AsyncListener, Recyclable {

    private final AtomicBoolean completed = new AtomicBoolean(false);
    private final JakartaEEAsyncContextAdviceHelperImpl asyncContextAdviceHelperImpl;
    ...
    JakartaEEApmAsyncListener(JakartaEEAsyncContextAdviceHelperImpl asyncContextAdviceHelperImpl) {
    ...
    JakartaEEApmAsyncListener withTransaction(Transaction transaction) {

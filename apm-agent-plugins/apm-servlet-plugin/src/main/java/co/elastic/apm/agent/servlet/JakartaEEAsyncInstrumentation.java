...
import co.elastic.apm.agent.servlet.helper.JakartaEEAsyncContextAdviceHelperImpl;
...
public abstract class JakartaEEAsyncInstrumentation extends JakartaEEAbstractServletInstrumentation {
    ...
    public interface JakartaEEAsyncContextAdviceHelper<T> {
        void onExitStartAsync(T asyncContext);
    }

    public static class StartAsyncInstrumentation extends JakartaEEAsyncInstrumentation {
        ...
        public ElementMatcher<? super TypeDescription> getTypeMatcher() {
            return not(isInterface())
                .and(hasSuperType(named("jakarta.servlet.ServletRequest")));
        }
        ...
        public ElementMatcher<? super MethodDescription> getMethodMatcher() {
            return isPublic()
                ...
                .and(returns(named("jakarta.servlet.AsyncContext")))
        ...
        public static class StartAsyncAdvice {
            private static final JakartaEEAsyncContextAdviceHelper<AsyncContext> asyncHelper = new JakartaEEAsyncContextAdviceHelperImpl(GlobalTracer.requireTracerImpl());
    ...
    public static class AsyncContextInstrumentation extends JakartaEEAsyncInstrumentation {
        ...
        public ElementMatcher<? super TypeDescription> getTypeMatcher() {
            return not(isInterface())
                .and(hasSuperType(named("jakarta.servlet.AsyncContext")));
        }

...
public abstract class JakartaEEAbstractServletInstrumentation extends TracerAwareInstrumentation {
    @Override
    ...
    public ElementMatcher.Junction<ClassLoader> getClassLoaderMatcher() {
        ...
        return CustomElementMatchers.classLoaderCanLoadClass("jakarta.servlet.AsyncContext");
    }
}

...
import co.elastic.apm.agent.servlet.helper.JakartaEERecordingServletInputStreamWrapper;
...
public class JakartaEERequestStreamRecordingInstrumentation extends JakartaEEAbstractServletInstrumentation {
    ...
    public ElementMatcher<? super TypeDescription> getTypeMatcher() {
        return hasSuperType(named("jakarta.servlet.ServletRequest")).and(not(isInterface()));
    }

    @Override
    public ElementMatcher<? super MethodDescription> getMethodMatcher() {
        return named("getInputStream").and(returns(named("jakarta.servlet.ServletInputStream")));
    }
    ...
    public static class GetInputStreamAdvice {
        ...
        public static ServletInputStream afterGetInputStream(@Advice.Return @Nullable ServletInputStream inputStream) {
            ...
            if (transaction != null && transaction.getContext().getRequest().getBodyBuffer() != null) {
                return new JakartaEERecordingServletInputStreamWrapper(transaction.getContext().getRequest(), inputStream);
            } else {
                return inputStream;
            }
        }

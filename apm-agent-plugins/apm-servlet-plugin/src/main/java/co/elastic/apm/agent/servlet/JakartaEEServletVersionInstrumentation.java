...
public abstract class JakartaEEServletVersionInstrumentation  extends JakartaEEAbstractServletInstrumentation {
    ...
    /**
     * Instruments {@link jakarta.servlet.Servlet#init(ServletConfig)}
     */
    public static class Init extends ServletVersionInstrumentation {
        ...
        public ElementMatcher<? super MethodDescription> getMethodMatcher() {
            return named("init")
                .and(takesArgument(0, named("jakarta.servlet.ServletConfig")));
        }
    ...
    /**
     * Instruments {@link jakarta.servlet.Servlet#service(ServletRequest, ServletResponse)}
     */
    ...
    private static void logServletVersion(@Nullable ServletConfig servletConfig) {
        ...
        logger.info("Jakarta servlet container info = {}", serverInfo);
        if (majorVersion < 3) {
            logger.warn("Unsupported jakarta servlet version detected: {}.{}, no Servlet transaction will be created", majorVersion, minorVersion);
        }
    }

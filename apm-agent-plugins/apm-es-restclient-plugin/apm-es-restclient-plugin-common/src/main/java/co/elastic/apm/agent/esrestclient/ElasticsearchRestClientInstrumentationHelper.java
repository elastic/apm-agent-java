...
public class ElasticsearchRestClientInstrumentationHelper {
    ...
    public ElasticsearchRestClientInstrumentationHelper() {
        responseListenerObjectPool = QueueBasedObjectPool.ofRecyclable(
            ...
            false,
            new ElasticsearchRestClientInstrumentationHelper.ResponseListenerAllocator());
    }
    ...
    @Nullable
    public Span createClientSpan(@Nullable AbstractSpan<?> activeSpan, String method, String endpoint, @Nullable HttpEntity httpEntity) {
        if (activeSpan == null) {
            return null;
        }

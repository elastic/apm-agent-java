...
public class TaskQueueInstrumentation extends Vertx4Instrumentation {
     ...
     * through java concurrent for the task queue.
     */
    @Override
    public ElementMatcher<? super MethodDescription> getMethodMatcher() {
        return named("execute")
            .and(takesArguments(Runnable.class, Executor.class));
    }

    @Override
    public String getAdviceClassName() {
        return "co.elastic.apm.agent.vertx.v4.TaskQueueInstrumentation$ExecuteAdvice";
    }

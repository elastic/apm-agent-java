...
public class Log4j1LoggerFacade implements LoggerFacade {

    private final Logger log4j1Logger;

    public Log4j1LoggerFacade() {
        String log4j1ConfigFile = Log4j1LoggerFacade.class.getClassLoader().getResource("log4j1.properties").getFile();

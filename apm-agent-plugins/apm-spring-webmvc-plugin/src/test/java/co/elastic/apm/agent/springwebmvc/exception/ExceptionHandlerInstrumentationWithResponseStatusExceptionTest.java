...
public class ExceptionHandlerInstrumentationWithResponseStatusExceptionTest extends AbstractExceptionHandlerInstrumentationTest {
    ...
    public void testCallApiWithExceptionThrown() throws Exception {
        ...
        assertExceptionCapture(ResponseStatusException.class, response, 409, "", "Response status 409 with reason \"responseStatusException\"; nested exception is co.elastic.apm.agent.springwebmvc.exception.testapp.response_status_exception.ResponseStatusRuntimeException: runtime exception occurred");

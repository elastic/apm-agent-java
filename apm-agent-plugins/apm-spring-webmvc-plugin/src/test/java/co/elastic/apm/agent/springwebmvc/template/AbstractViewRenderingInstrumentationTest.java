...
import co.elastic.apm.agent.servlet.JakartaServletInstrumentation;
...
abstract class AbstractViewRenderingInstrumentationTest {
    ...
    static void beforeAll() {
        ...
        ElasticApmAgent.initInstrumentation(tracer, ByteBuddyAgent.install(), Arrays.asList(new JakartaServletInstrumentation(), new JavaxServletInstrumentation(), new ViewRenderInstrumentation()));
    }

...
import co.elastic.apm.agent.spring.webmvc.exception.testapp.response_status_exception.ResponseStatusExceptionController;
import co.elastic.apm.agent.spring.webmvc.exception.testapp.response_status_exception.ResponseStatusRuntimeException;
...
public class ExceptionHandlerInstrumentationWithResponseStatusExceptionTest extends AbstractExceptionHandlerInstrumentationTest {
    ...
    public void testCallApiWithExceptionThrown() throws Exception {
        ...
        assertExceptionCapture(0, 1, ResponseStatusException.class, response, 409, "", "Response status 409 with reason \"responseStatusException\"; nested exception is ResponseStatusRuntimeException: runtime exception occured");

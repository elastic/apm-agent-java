...
class BootstrapChecksTest {
    ...
    void testBootstrapChecks() {
        assertThat(new BootstrapChecks(true, errors -> errors.add("Fail")).isPassing()).isFalse();
        assertThat(new BootstrapChecks(false, errors -> errors.add("Fail")).isPassing()).isTrue();

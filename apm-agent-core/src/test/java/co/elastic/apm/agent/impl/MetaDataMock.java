...
public class MetaDataMock {
     ...
     */
    public static Future<MetaData> create(ProcessInfo process, Service service, SystemInfo system, @Nullable CloudProviderInfo cloudProviderInfo, Map<String, String> globalLabels) {

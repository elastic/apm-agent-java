...
class SpanTypeBreakdownTest {
    ...
    void testBreakdown_disabled() {
        doReturn(false).when(tracer.getConfig(CoreConfigurationImpl.class)).isBreakdownMetricsEnabled();
        createTransaction()
            .end(30);
        tracer.getMetricRegistry().flipPhaseAndReport(metricSets -> {
    ...
    void testBreakdown_concurrentDbSpans_fullyOverlapping() {
        final TransactionImpl transaction = createTransaction();
        final SpanImpl span1 = transaction.createSpan(10).withType("db").withSubtype("mysql");
        final SpanImpl span2 = transaction.createSpan(10).withType("db").withSubtype("mysql");
        span1.end(20);
        span2.end(20);
        transaction.end(30);
    ...
    void testBreakdown_concurrentDbSpans_partiallyOverlapping() {
        final TransactionImpl transaction = createTransaction();
        final SpanImpl span1 = transaction.createSpan(10).withType("db").withSubtype("mysql");
        final SpanImpl span2 = transaction.createSpan(15).withType("db").withSubtype("mysql");
        span1.end(20);
        span2.end(25);
        transaction.end(30);
    ...
    void testBreakdown_asyncGrandchildExceedsChild() {
        final TransactionImpl transaction = createTransaction();
        final SpanImpl app = transaction.createSpan(10).withType("app");
        final SpanImpl db = app.createSpan(15).withType("db").withSubtype("mysql");
        app.end(20);
        db.end(25);
        transaction.end(30);
    ...
    void testBreakdown_asyncGrandchildExceedsChildAndTransaction() {
        ...
        final SpanImpl db = app.createSpan(20).withType("db").withSubtype("mysql");
        app.end(30);
        db.end(30);
    ...
    void testBreakdown_singleDbSpan_exceedingParent() {
        final TransactionImpl transaction = createTransaction();
        final SpanImpl span = transaction.createSpan(10).withType("db").withSubtype("mysql");
        transaction.end(20);
        span.end(30);
    ...
    void testBreakdown_spanStartedAfterParentEnded() {
        ...
        final AbstractSpanImpl<?> active = tracer.getActive();

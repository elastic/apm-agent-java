...
class TraceContextTest {
    ...
    void parseFromTraceParentHeader_sampled() {
        ...
        traceContext.parseFromTraceParentHeader(header);
    ...
    void testResetState() {
        final TraceContext traceContext = new TraceContext();
        traceContext.parseFromTraceParentHeader("00-0af7651916cd43dd8448eb211c80319c-b9c7c989f97918e1-00");
    ...
    void testRandomValue() {
        final TraceContext traceContext = new TraceContext();
        traceContext.randomRootContext(true);

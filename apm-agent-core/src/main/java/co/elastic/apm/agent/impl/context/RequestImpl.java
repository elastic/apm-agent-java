...
public class RequestImpl implements Recyclable, Request {
    ...
    private static final ObservableObjectPool<CharBuffer> charBufferPool = QueueBasedObjectPool.of(new MpmcAtomicArrayQueue<CharBuffer>(128), false,
    ...
    @Override
    public RequestImpl addHeader(String headerName, @Nullable Enumeration<String> headerValues) {

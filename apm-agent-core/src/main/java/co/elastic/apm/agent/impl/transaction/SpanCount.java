...
public class SpanCount implements Recyclable {
    ...
    private final AtomicInteger droppedMinDuration = new AtomicInteger(0);
    ...
    public AtomicInteger getDroppedMinDuration() {
        return droppedMinDuration;
    }

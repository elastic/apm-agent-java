...
public class ReporterConfigurationImpl extends ConfigurationOptionProvider implements ReporterConfiguration {
     ...
     * for the singular form. If {@link ReporterConfigurationImpl#serverUrl} is set with an empty string and
     * {@link ReporterConfigurationImpl#serverUrls} is not set, this method is expected to provide an empty list.
     *
     * Algorithm:

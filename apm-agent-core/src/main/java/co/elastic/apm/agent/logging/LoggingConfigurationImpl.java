 ...
 * </p>
 */
public class LoggingConfigurationImpl extends ConfigurationOptionProvider implements LoggingConfiguration {
    ...
    private static void setLogLevel(@Nullable LogLevel level) {
        ...
        if (contextFactory instanceof Log4jContextFactory) {
            ...
            LoggerFactory.getLogger(LoggingConfigurationImpl.class).warn("Unexpected type of LoggerContextFactory - {}, " +

 ...
 */
public class IdImpl implements Recyclable, Id {
    ...
    public static IdImpl new128BitId() {
        return new IdImpl(16);
    }

    public static IdImpl new64BitId() {
        return new IdImpl(8);
    }

    private IdImpl(int idLengthBytes) {
    ...
    public <T> void fromHexString(T hexEncodedString, int offset, CharAccessor<T> accessor) {
        accessor.readHex(hexEncodedString, offset, data);
        onMutation();
    }
    ...
    public void copyFrom(IdImpl other) {

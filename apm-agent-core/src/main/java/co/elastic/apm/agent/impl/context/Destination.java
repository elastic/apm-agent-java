 ...
 */
public class Destination implements Recyclable, co.elastic.apm.tracer.api.metadata.Destination {
    ...
    public static class Cloud implements Recyclable, co.elastic.apm.tracer.api.metadata.Cloud {

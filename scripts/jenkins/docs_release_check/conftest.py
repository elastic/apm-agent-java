...
<ul class="itemizedlist">
<li class="listitem">
CLI example: <code class="literal">--config server_url=http://localhost:8200,http://localhost:8201</code>
</li>
<li class="listitem">
API example: <code class="literal">ElasticApmAttacher.attach(Map.of("server_url", "http://localhost:8200,http://localhost:8201"));</code>
</li>
</ul>
</div>
</li>

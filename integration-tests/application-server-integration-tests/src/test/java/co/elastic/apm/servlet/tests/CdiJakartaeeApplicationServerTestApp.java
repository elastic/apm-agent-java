...
public class CdiJakartaeeApplicationServerTestApp extends TestApp {

    public CdiJakartaeeApplicationServerTestApp() {
        super("../cdi-jakartaee-app/cdi-jakartaee-app-dependent",
    ...
    public void test(AbstractServletContainerIntegrationTest containerIntegrationTest) throws Exception {
        String testPath = "/cdi-jakartaee-app/greeter";
        ...
        assertThat(transaction.get("name").textValue()).isEqualTo("GreeterEE9Servlet#doGet");
        ...
        assertThat(cdiSpan1.get("name").textValue()).isEqualTo("GreeterEE9ManagerImpl#greet");

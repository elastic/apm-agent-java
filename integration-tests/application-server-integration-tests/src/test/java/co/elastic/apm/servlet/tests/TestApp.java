...
public abstract class TestApp {
    ...
    TestApp(String modulePath, String appFileName, String deploymentContext, String statusEndpoint, @Nullable String expectedServiceName, String expectedVersion) {

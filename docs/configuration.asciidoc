...
** <<config-url-groups>>
** <<config-use-path-template-as-transaction-name>>
* <<config-jax-rs>>
...
[float]
[[config-use-path-template-as-transaction-name]]
==== `use_path_template_as_transaction_name`
...
|============
| Java System Properties      | Property file   | Environment
| `elastic.apm.use_path_template_as_transaction_name` | `use_path_template_as_transaction_name` | `ELASTIC_APM_USE_PATH_TEMPLATE_AS_TRANSACTION_NAME`
|============
...
# Default value: false
#
# use_path_template_as_transaction_name=false

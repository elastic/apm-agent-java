...
* <<config-jdbc>>
** <<config-sqls-excluded-from-jdbc-instrumentation>>
* <<config-jmx>>
...
[float]
[[config-sqls-excluded-from-jdbc-instrumentation]]
==== `sqls_excluded_from_jdbc_instrumentation` (added[1.28.0])

A list of SQLs that should be ignored and not captured as spans.
...
|============
| Java System Properties      | Property file   | Environment
| `elastic.apm.sqls_excluded_from_jdbc_instrumentation` | `sqls_excluded_from_jdbc_instrumentation` | `ELASTIC_APM_SQLS_EXCLUDED_FROM_JDBC_INSTRUMENTATION`
|============
...
# Default value: 
#
# sqls_excluded_from_jdbc_instrumentation=

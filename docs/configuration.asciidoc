...
.Properties of `circuit_breaker_enabled`
[%collapsible%open]
=====
...
.Properties of `stress_monitoring_interval`
[%collapsible%open]
=====
...
.Properties of `stress_monitor_gc_stress_threshold`
[%collapsible%open]
=====
...
.Properties of `stress_monitor_gc_relief_threshold`
[%collapsible%open]
=====
...
.Properties of `stress_monitor_cpu_duration_threshold`
[%collapsible%open]
=====
...
.Properties of `stress_monitor_system_cpu_stress_threshold`
[%collapsible%open]
=====
...
.Properties of `stress_monitor_system_cpu_relief_threshold`
[%collapsible%open]
=====
...
.Properties of `service_node_name`
[%collapsible%open]
=====
...
.Properties of `transaction_sample_rate`
[%collapsible%open]
=====
...
.Properties of `transaction_max_spans`
[%collapsible%open]
=====
...
.Properties of `sanitize_field_names`
[%collapsible%open]
=====
...
.Properties of `disable_instrumentations`
[%collapsible%open]
=====
...
.Properties of `unnest_exceptions`
[%collapsible%open]
=====
...
.Properties of `ignore_exceptions`
[%collapsible%open]
=====
...
.Properties of `trace_methods_duration_threshold`
[%collapsible%open]
=====
...
.Properties of `boot_delegation_packages`
[%collapsible%open]
=====
...
.Properties of `breakdown_metrics`
[%collapsible%open]
=====
...
.Properties of `use_elastic_traceparent_header`
[%collapsible%open]
=====
...
.Properties of `capture_body_content_types`
[%collapsible%open]
=====
...
.Properties of `ignore_user_agents`
[%collapsible%open]
=====
...
.Properties of `use_path_as_transaction_name`
[%collapsible%open]
=====
...
.Properties of `enable_jaxrs_annotation_inheritance`
[%collapsible%open]
=====
...
.Properties of `use_jaxrs_path_as_transaction_name`
[%collapsible%open]
=====
...
.Properties of `capture_jmx_metrics`
[%collapsible%open]
=====
...
.Properties of `enable_log_correlation`
[%collapsible%open]
=====
...
.Properties of `ignore_message_queues`
[%collapsible%open]
=====
...
.Properties of `profiling_inferred_spans_enabled`
[%collapsible%open]
=====
...
.Properties of `profiling_inferred_spans_sampling_interval`
[%collapsible%open]
=====
...
.Properties of `profiling_inferred_spans_min_duration`
[%collapsible%open]
=====
...
.Properties of `profiling_inferred_spans_included_classes`
[%collapsible%open]
=====
...
.Properties of `profiling_inferred_spans_excluded_classes`
[%collapsible%open]
=====
...
.Properties of `verify_server_cert`
[%collapsible%open]
=====
...
.Properties of `include_process_args`
[%collapsible%open]
=====
...
.Properties of `api_request_time`
[%collapsible%open]
=====
...
.Properties of `api_request_size`
[%collapsible%open]
=====
...
.Properties of `metrics_interval`
[%collapsible%open]
=====
...
.Properties of `application_packages`
[%collapsible%open]
=====
...
.Properties of `stack_trace_limit`
[%collapsible%open]
=====
...
.Properties of `span_frames_min_duration`
[%collapsible%open]
=====

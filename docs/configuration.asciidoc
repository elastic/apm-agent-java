...
** <<config-stress-monitor-cpu-num-measurements>>
...
[float]
[[config-stress-monitor-cpu-num-measurements]]
==== `stress_monitor_cpu_num_measurements` (performance)

The number of measurements required in order to determine whether the system is 
...
|============
| Java System Properties      | Property file   | Environment
| `elastic.apm.stress_monitor_cpu_num_measurements` | `stress_monitor_cpu_num_measurements` | `ELASTIC_APM_STRESS_MONITOR_CPU_NUM_MEASUREMENTS`
|============
...
# Default value: 12
#
# stress_monitor_cpu_num_measurements=12

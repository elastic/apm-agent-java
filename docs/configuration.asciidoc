...
[float]
[[config-use-path-annotation-value-for-transaction-name]]
==== `use_path_annotation_value_for_transaction_name` (internal)
...
|============
| Java System Properties      | Property file   | Environment
| `elastic.apm.use_path_annotation_value_for_transaction_name` | `use_path_annotation_value_for_transaction_name` | `ELASTIC_APM_USE_PATH_ANNOTATION_VALUE_FOR_TRANSACTION_NAME`
|============

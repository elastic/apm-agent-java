...
If any baggage key matches any of the patterns provided via this config option, the corresponding baggage key and value will be automaticalyl stored on the corresponding transactions and spans. The baggage keys will be prefixed with "baggage." on storage.

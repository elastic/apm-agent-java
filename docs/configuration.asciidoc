...
Valid options are `annotations`, `apache-httpclient`, `asynchttpclient`, `concurrent`, `elasticsearch-restclient`, `exception-handler`, `executor`, `freemarker-view`, `groovy-template-view`, `hibernate-search`, `http-client`, `incubating`, `jackson2json-view`, `jade4j-template-view`, `jax-rs`, `jax-ws`, `jdbc`, `jms`, `jsf`, `jsp-view`, `logging`, `okhttp`, `opentracing`, `public-api`, `quartz`, `render`, `scheduled`, `servlet-api`, `servlet-api-async`, `servlet-input-stream`, `slf4j`, `spring-mvc`, `spring-resttemplate`, `spring-service-name`, `thymeleaf-view`, `urlconnection`.

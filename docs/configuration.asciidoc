...
Valid options are `annotations`, `apache-httpclient`, `asynchttpclient`, `concurrent`, `elasticsearch-restclient`, `exception-handler`, `executor`, `freemarker-view`, `hibernate-search`, `http-client`, `incubating`, `jackson2json-view`, `jax-rs`, `jax-ws`, `jdbc`, `jms`, `jsf`, `jsp-view`, `okhttp`, `opentracing`, `public-api`, `quartz`, `render`, `scheduled`, `servlet-api`, `servlet-api-async`, `servlet-input-stream`, `spring-mvc`, `spring-resttemplate`, `spring-service-name`, `thymeleaf-view`, `urlconnection`.

...
|============
| Default                          | Type                | Dynamic
| `org.springframework.web.servlet.DispatcherServlet#render(*, *, *)` | List | false
|============
...
# This setting can not be changed at runtime. Changes require a restart of the application.
# Type: comma separated list
# Default value: org.springframework.web.servlet.DispatcherServlet#render(*, *, *)
#
# trace_methods=org.springframework.web.servlet.DispatcherServlet#render(*, *, *)

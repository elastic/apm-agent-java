...
WARNING: If your URLs contain path parameters like `/user/$userId`,you should NOT enable this flag,as it leads to an explosion of transaction groups.

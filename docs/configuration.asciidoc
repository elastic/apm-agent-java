...
** <<config-profiling-logging-disabled>>
...
[float]
[[config-profiling-logging-disabled]]
==== `profiling_logging_disabled` (added[1.37.0])
...
|============
| Java System Properties      | Property file   | Environment
| `elastic.apm.profiling_logging_disabled` | `profiling_logging_disabled` | `ELASTIC_APM_PROFILING_LOGGING_DISABLED`
|============
...
# Default value: false
#
# profiling_logging_disabled=false

...
The minimum required OpenTelemetry version is 0.14.1.

NOTE: Be aware that non GA (0.x) versions of the OpenTelemetry API are not stable and don't guarantee backward compatibility.
This means that you may have to adapt your instrumentation code when updating to newer versions.

...
==== `void setServiceInfoForClassLoader(ClassLoader, String, String)` added[1.29.0]
...
==== `Transaction setServiceInfo(String serviceName, String serviceVersion)` added[1.29.0]
...
==== `Transaction useServiceInfoForClassLoader(ClassLoader classLoader)` added[1.29.0]

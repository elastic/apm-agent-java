...
[float]
[[api-span-inject-trace-headers]]
==== `Span withDestinationServiceResource(String resource)` added[1.9.1]

* `resource`: an appended destination service resource value
...
[source,java]
----
Span span = parent.startSpan("db", "mongodb", "find");
try {
    span.setName("test")
        .withDestinationServiceResource("mongodb");
    // do your thing...
} catch (Exception e) {
    span.captureException(e);
    throw e;
...
[float]
[[api-span-inject-trace-headers]]
==== `Span withDestinationServiceName(String name)` added[1.9.1]

* `name`: an appended destination service name value
...
try {
    span.setName("test")
        .withDestinationServiceName("mongodb");
    // do your thing...
} catch (Exception e) {
    span.captureException(e);
    throw e;
...
[float]
[[api-span-inject-trace-headers]]
==== `Span setDestinationServiceType(String type)` added[1.9.1]

* `type`: a destination service type value

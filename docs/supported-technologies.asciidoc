...
|JMS
|1.1, 2.0
|The agent propagates the context when using `javax.jms.MessageConsumer#send` and `javax.jms.JMSConsumer#send` methods
through a `Message` property
|1.7.0 - EXPERIMENTAL (off by default)

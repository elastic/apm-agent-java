...
| Apache HttpClient (Legacy) | 3.0.x and ≤ JDK 25                                       | Requires setting [`instrument_ancient_bytecode`](/reference/config-core.md#config-instrument-ancient-bytecode) to `true`                                                                                   | 1.35.0                                                                                          |
...
| Spring RestClient          | ≥ 6.1.0, ≤ 6.x                                           |                                                                                                                                                                                                            | 1.45.0                                                                                          |

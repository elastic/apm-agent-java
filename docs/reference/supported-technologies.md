...
| Logback                   | 1.1.x, 1.2.x, 1.3.x, 1.4.x                                 | [`org.slf4j.MDC`](https://www.slf4j.org/api/org/slf4j/MDC.md) is used for correlation.                                                                                 | Correlation (traces) - 1.0.0<br>Correlation (service) - 1.38.0<br>ECS Reformatting - 1.22.0                                                                        |

...
link:{apm-server-ref-64}/transactions.html[`Transaction`],
subsequent spans are mapped to Elastic APM
link:{apm-server-ref-64}/transactions.html#transaction-spans[`Span`]s.
...
link:{apm-server-ref-64}/errors.html[`Error`].
Example:

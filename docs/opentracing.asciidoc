...
{apm-get-started-ref}/transaction-spans.html[Spans].
...
Logging an Exception on the OpenTracing span will create an Elastic APM {apm-get-started-ref}/errors.html[Errors].
Example:

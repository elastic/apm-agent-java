...
### Features and enhancements [elastic-apm-java-agent-1520-features-enhancements]
...
### Fixes [elastic-apm-java-agent-1500-fixes]
...
## 1.47.1 [elastic-apm-java-agent-1471-release-notes]
...
## 1.44.0 [elastic-apm-java-agent-1440-release-notes]
...
## 1.42.0 [elastic-apm-java-agent-1420-release-notes]
...
### Features and enhancements [elastic-apm-java-agent-1400-features-enhancements]
...
### Fixes [elastic-apm-java-agent-1380-fixes]
...
## 1.36.0 [elastic-apm-java-agent-1360-release-notes]
...
### Fixes [elastic-apm-java-agent-1340-fixes]
...
### Features and enhancements [elastic-apm-java-agent-1320-features-enhancements]
...
### Fixes [elastic-apm-java-agent-1310-fixes]
...
### Fixes [elastic-apm-java-agent-1283-fixes]
...
### Features and enhancements [elastic-apm-java-agent-1271-features-enhancements]
...
## 1.24.0 [elastic-apm-java-agent-1240-release-notes]
...
* The [`use_path_as_transaction_name`](/reference/config-http.md#config-use-path-as-transaction-name) option is now dynamic
...
## 1.20.0 [elastic-apm-java-agent-1200-release-notes]
...
### Features and enhancements [elastic-apm-java-agent-1180-features-enhancements]
...
### Fixes [elastic-apm-java-agent-1150-fixes]
...
### Fixes [elastic-apm-java-agent-1130-fixes]
...
### Fixes [elastic-apm-java-agent-1100-fixes]
...
## 1.9.0 [elastic-apm-java-agent-190-release-notes]
**Release date:** August 22, 2019

### Features and enhancements [elastic-apm-java-agent-190-features-enhancements]
...
* The runtime attachment now also works when the `tools.jar` or the `jdk.attach` module is not available. This means you don’t need a full JDK installation - the JRE is sufficient. This makes the runtime attachment work in more environments such as minimal Docker containers. Note that the runtime attachment currently does not work for OSGi containers like those used in many application servers such as JBoss and WildFly. See the [documentation](/reference/setup-attach-cli.md) for more information.
* Support for Hibernate Search

### Fixes [elastic-apm-java-agent-190-fixes]
...
## 1.8.0 [elastic-apm-java-agent-180-release-notes]
**Release date:** July 30, 2019

### Features and enhancements [elastic-apm-java-agent-180-features-enhancements]
...
* Added option to use `@javax.ws.rs.Path` value as transaction name [`use_jaxrs_path_as_transaction_name`](/reference/config-jax-rs.md#config-use-jaxrs-path-as-transaction-name)
* Instrument quartz jobs [docs](/reference/supported-technologies.md#supported-scheduling-frameworks)
* SQL parsing improvements [#696](https://github.com/elastic/apm-agent-java/pull/696)
* Introduce priorities for transaction name [#748](https://github.com/elastic/apm-agent-java/pull/748). Now uses the path as transaction name if [`use_path_as_transaction_name`](/reference/config-http.md#config-use-path-as-transaction-name) is set to `true` rather than `ServletClass#doGet`. But if a name can be determined from a high level framework, like Spring MVC, that takes precedence. User-supplied names from the API always take precedence over any others.
...
### Fixes [elastic-apm-java-agent-180-fixes]
...
## 1.7.0 [elastic-apm-java-agent-170-release-notes]
**Release date:** June 13, 2019

### Features and enhancements [elastic-apm-java-agent-170-features-enhancements]
...
### Fixes [elastic-apm-java-agent-170-fixes]
...
## 1.6.1 [elastic-apm-java-agent-161-release-notes]
**Release date:** April 26, 2019

### Fixes [elastic-apm-java-agent-161-fixes]
...
## 1.6.0 [elastic-apm-java-agent-160-release-notes]
**Release date:** April 16, 2019

### Features and enhancements [elastic-apm-java-agent-160-features-enhancements]
...
### Fixes [elastic-apm-java-agent-160-fixes]
...
## 1.5.0 [elastic-apm-java-agent-150-release-notes]
**Release date:** March 26, 2019

### Features and enhancements [elastic-apm-java-agent-150-features-enhancements]
...
### Fixes [elastic-apm-java-agent-150-fixes]
...
## 1.4.0 [elastic-apm-java-agent-140-release-notes]
**Release date:** February 14, 2019

### Features and enhancements [elastic-apm-java-agent-140-features-enhancements]
...
### Fixes [elastic-apm-java-agent-140-fixes]
...
## 1.3.0 [elastic-apm-java-agent-130-release-notes]
**Release date:** January 10, 2019

### Features and enhancements [elastic-apm-java-agent-130-features-enhancements]
...
### Fixes [elastic-apm-java-agent-130-fixes]
...
## 1.2.0 [elastic-apm-java-agent-120-release-notes]
**Release date:** December 19, 2018

### Features and enhancements [elastic-apm-java-agent-120-features-enhancements]
...
### Fixes [elastic-apm-java-agent-120-fixes]
...
## 1.1.0 [elastic-apm-java-agent-110-release-notes]
**Release date:** November 28, 2018

### Features and enhancements [elastic-apm-java-agent-110-features-enhancements]
* Some memory allocation improvements
* Enabling bootdelegation for agent classes in Atlassian OSGI systems

### Fixes [elastic-apm-java-agent-110-fixes]
...
## 1.0.1 [elastic-apm-java-agent-101-release-notes]
**Release date:** November 15, 2018

### Fixes [elastic-apm-java-agent-101-fixes]
...
## 1.0.0 [elastic-apm-java-agent-100-release-notes]
**Release date:** November 14, 2018

### Features and enhancements [elastic-apm-java-agent-100-features-enhancements]
* Adds `@CaptureTransaction` and `@CaptureSpan` annotations which let you declaratively add custom transactions and spans. Note that it is required to configure the `application_packages` for this to work. See the [documentation](/reference/public-api.md#api-annotation) for more information.
* The public API now supports to activate a span on the current thread. This makes the span available via `ElasticApm#currentSpan()` Refer to the [documentation](/reference/public-api.md#api-span-activate) for more details.
...
* Added API methods to enable correlating the spans created from the JavaScrip Real User Monitoring agent with the Java agent transaction. More information can be found in the [documentation](/reference/public-api.md#api-ensure-parent-id).
...
### Fixes [elastic-apm-java-agent-100-fixes]

...
[float]
===== Bug fixes
* If the application class loader is not able to find/load a logging class for log correlation, the context/system class loader is uses instead - {pull}2374[#2374]

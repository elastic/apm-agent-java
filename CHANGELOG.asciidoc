...
* Renamed `span_frames_min_duration` to `span_stack_trace_min_duration`. Updated logic with enabling and disabling of the stack traces capturing. - {pull}2220[#2220]

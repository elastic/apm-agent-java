...
* Fixed prevention the shade plugin from relocating `org.slf4j.Logger` to `co.elastic.apm.agent.shaded.slf4j.Logger`
in `Log4jLoggingInstrumentation` and `Slf4jLoggingInstrumentation`.  - {pull}1049[#1049]

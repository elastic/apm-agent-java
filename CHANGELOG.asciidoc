...
* Added <<config-span-stack-trace-min-duration,`span_stack_trace_min_duration`>> option. This options sets the minimum duration of a span
for which stack frames will be captured. This option works together with `span_frames_min_duration` - {pull}2220[#2220]
